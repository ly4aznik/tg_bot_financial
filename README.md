...
5. Введите описание минимум из двух символов. Бот сохраняет его в нижнем регистре.
...
Команда `/recent` или кнопка `Последние 10` показывает десять последних сохранённых расходов.
